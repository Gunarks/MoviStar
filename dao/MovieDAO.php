...
class MovieDAO implements MovieDAOInterface
{
    ...
    public function create(Movie $movie)
    {
        ...
        // Mensagem de sucesso por aidcionar o filme
    ...
    public function update(Movie $movie)
    {
        ...
        // Mensagem de sucesso por aidcionar o filme
        $this->message->setMessage("Filme adicionado com sucesso!!", "success", "dashboard.php");
    }
    ...
    public function destroy($id)
    {
        ...
        // Mensagem de sucessi por remover o filme
