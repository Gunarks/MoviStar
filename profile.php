...
// print_r($movieDao->getMoviesByUserId($id));
// exit;
    ...
    <div class="col-md-8 offset-md-2">
        <div class="row profile-container">
            <div class="col-md-12 about-container">
                ...
                <div id="profile-image-container" class="profile-image" style="background-image: url('<?= $BASE_URL ?>img/users/<?php echo $userData->image ?>')"></div>
